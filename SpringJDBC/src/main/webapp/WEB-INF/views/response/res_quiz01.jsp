...
<body>
	...
	model 방식
	<form action="res_login2" method="post">
		ID: <input type="text" name="id2" size="10"><br>
		PW: <input type="password" name="pw2" size="10"><br>
		<input type="submit" value="로그인">
	</form>
	
	model and view 방식
	<form action="res_login3" method="post">
		ID: <input type="text" name="id3" size="10"><br>
		PW: <input type="password" name="pw3" size="10"><br>
		<input type="submit" value="로그인">
	</form>
